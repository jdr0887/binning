...
@Embeddable
public class SNPPopulationMaxFrequencyPK implements Serializable {
    ...
    public SNPPopulationMaxFrequencyPK() {
        super();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        SNPPopulationMaxFrequencyPK other = (SNPPopulationMaxFrequencyPK) obj;
        if (version == null) {

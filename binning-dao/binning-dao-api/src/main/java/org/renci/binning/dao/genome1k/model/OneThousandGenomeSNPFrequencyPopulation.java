...
@NamedQueries({
        @NamedQuery(name = "genome1k.OneThousandGenomeSNPFrequencyPopulation.findByLocatedVariantIdAndVersion", query = "FROM OneThousandGenomeSNPFrequencyPopulation a join a.LocatedVariant b where b.id = :LocatedVariantId and a.key.version = :version") })

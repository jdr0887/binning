...
public class IndelMaxFrequency implements Persistable {

    private static final long serialVersionUID = 7870826168521038137L;

    @EmbeddedId
    private IndelMaxFrequencyPK key;
    ...
    public IndelMaxFrequency() {
        super();
    }

    public IndelMaxFrequencyPK getKey() {
        return key;
    }

    public void setKey(IndelMaxFrequencyPK key) {
        this.key = key;
    }
    ...
    public String toString() {
        return String.format("IndelMaxFrequency [key=%s, maxAlleleFrequency=%s]", key, maxAlleleFrequency);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        IndelMaxFrequency other = (IndelMaxFrequency) obj;
        if (key == null) {
            if (other.key != null)
                return false;

...
public class VariantsFactory {
    ...
    public static Variants_78_4 createIntronicVariant(BinningDAOBeanService daoBean, String refseqVersion, LocatedVariant locatedVariant,
    ...
    public static Variants_78_4 createBorderCrossingVariant(BinningDAOBeanService daoBean, String refseqVersion,
    ...
    public static Variants_78_4 createExonicVariant(BinningDAOBeanService daoBean, String refseqVersion, LocatedVariant locatedVariant,

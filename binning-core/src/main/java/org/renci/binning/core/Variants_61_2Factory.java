...
public class Variants_61_2Factory {

    private static final Logger logger = LoggerFactory.getLogger(Variants_61_2Factory.class);
    ...
    public static Variants_61_2 createIntronicVariant(BinningDAOBeanService daoBean, String refseqVersion, LocatedVariant locatedVariant,
        ...
        Variants_61_2PK variantKey = new Variants_61_2PK(locatedVariant.getId(), tMap.getGenomeRefSeq().getVerAccession(),

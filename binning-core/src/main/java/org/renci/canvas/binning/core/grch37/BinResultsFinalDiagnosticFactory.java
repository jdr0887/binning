...
public class BinResultsFinalDiagnosticFactory {
    ...
    public List<BinResultsFinalDiagnostic> findHGMDKnownPathogenic(DiagnosticBinningJob diagnosticBinningJob, List<Variants_61_2> variants)
        ...
        if (CollectionUtils.isNotEmpty(variants)) {
            ...
            for (Variants_61_2 variant : variants) {
                ...
                BinResultsFinalDiagnostic binResultsFinalDiagnostic = createHGMDBinResultsFinalDiagnostic(diagnosticBinningJob, variant,
    ...
    public List<BinResultsFinalDiagnostic> findClinVarKnownPathogenic(DiagnosticBinningJob diagnosticBinningJob,
        ...
        if (CollectionUtils.isNotEmpty(variants)) {
            ...
            for (Variants_61_2 variant : variants) {
                ...
                BinResultsFinalDiagnostic binResultsFinalDiagnostic = createClinVarBinResultsFinalDiagnostic(diagnosticBinningJob, variant,
                        diseaseClass, diagnosticGene, maxFrequency, maxNCGenesFrequenciesVersion, snpMappingAgg);
                results.add(binResultsFinalDiagnostic);
    ...
    public List<BinResultsFinalDiagnostic> findHGMDLikelyPathogenic(DiagnosticBinningJob diagnosticBinningJob, List<Variants_61_2> variants)
            throws CANVASDAOException {
        ...
        if (CollectionUtils.isNotEmpty(variants)) {
            ...
            for (Variants_61_2 variant : variants) {
                ...
                if (maxFrequency.getMaxAlleleFreq() < 0.01) {
                    ...
                    BinResultsFinalDiagnostic binResultsFinalDiagnostic = createClinVarBinResultsFinalDiagnostic(diagnosticBinningJob,
    ...
    public List<BinResultsFinalDiagnostic> findHGMDLikelyBenign(DiagnosticBinningJob diagnosticBinningJob, List<Variants_61_2> variants)
            throws CANVASDAOException {
        logger.debug("ENTERING findKnownPathogenic(DiagnosticBinningJob)");
        List<BinResultsFinalDiagnostic> results = new ArrayList<>();
    ...
    public List<BinResultsFinalDiagnostic> findClinVarLikelyBenign(DiagnosticBinningJob diagnosticBinningJob, List<Variants_61_2> variants)
            throws CANVASDAOException {
        logger.debug("ENTERING findKnownPathogenic(DiagnosticBinningJob)");
        List<BinResultsFinalDiagnostic> results = new ArrayList<>();
    ...
    private BinResultsFinalDiagnostic createClinVarBinResultsFinalDiagnostic(DiagnosticBinningJob diagnosticBinningJob,
            Variants_61_2 variant, DiseaseClass clinvarDiseaseClass, DiagnosticGene diagnosticGene, MaxFrequency maxFrequency,
    ...
    private BinResultsFinalDiagnostic createHGMDBinResultsFinalDiagnostic(DiagnosticBinningJob diagnosticBinningJob, Variants_61_2 variant,

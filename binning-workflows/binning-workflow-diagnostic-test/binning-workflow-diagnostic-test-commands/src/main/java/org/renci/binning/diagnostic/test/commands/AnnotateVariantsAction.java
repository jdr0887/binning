...
import org.renci.binning.diagnostic.test.commons.AnnotateVariantsCallable;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

@Command(scope = "diagnostic-test", name = "annotate-variants", description = "Annotate Variants")
@Service

...
public class DiagnosticUNCSeqTask implements Runnable {
    ...
    public DiagnosticUNCSeqTask() {
        super();
    }

    public DiagnosticUNCSeqTask(BinningDAOBeanService binningDAOBeanService, DiagnosticBinningJob binningJob, ProcessEngine processEngine) {
        super();
